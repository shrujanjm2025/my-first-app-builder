    ...
    const load = async () => {
      ...
      if (profile) {
        ...
        setData({
          ...
          other_income: (profile.other_income as IncomeSource[]) || [],
          loans: (profile.loans as LoanEntry[]) || [],
          insurance: (profile.insurance as InsuranceEntry[]) || [],
          credit_score: profile.credit_score || 650,
          fds_rds: (profile.fds_rds as FdRdEntry[]) || [],
